...
<head>
    ...
    <link rel="icon" type="image/svg" href="{{ asset('assets/images/logo-padang.png') }}">
            ...
            <div class="sidebar-section bg-black bg-opacity-10 border-bottom border-bottom-white border-opacity-10">
                <div class="sidebar-logo d-flex justify-content-center align-items-center">
                    <a href="/" class="d-inline-flex align-items-center py-2">
                        <img src="{{ asset('assets/images/logo-padang.png') }}" class="sidebar-logo-icon"
                            alt="">
                    ...
                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <ul class="nav-group-sub collapse">
                                <li class="nav-item"> <a href="{{ route('reports.index') }}" id="reportMenu"
                                        class="nav-link">
                                        <i class="ph-book-open"></i>
                                        <span>Laporan Opd</span>
                                    </a>
                                </li>
                                <li class="nav-item"><a href="{{ route('reports.transaction') }}" class="nav-link">
                                        <i class="ph-money"></i>
                                        <span>Laporan trx</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
