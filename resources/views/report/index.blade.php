    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-wrap justify-content-start">
                ...
                <div class="me-2 mb-3">
                    <input class="form-control datepicker-pick-level" id="date" name="date" placeholder="bulan/tahun">
                </div>
                <div class="me-2 mb-3">
        ...
        $(function () {
            ...
            function loadReport() {
                let reportTable = $('#reportTable').DataTable({
                    ...
                    columns: [
                        { data: 'name' },
                        { data: 'balance.total_deposit', className: 'text-end',
                            render: function (data) {
                                return (data) ? data.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1.") : 0;
                            }
                        },
                        { data: 'balance.total_payment', className: 'text-end',
                            render: function (data) {
                                return (data) ? data.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1.") : 0;
                            }
                        },
                        { data: 'balance.payment_on_cash', className: 'text-end',
                            render: function (data) {
                                return (data) ? data.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1.") : 0;
                            }
                        },
